...
# 2 "<built-in>" 2
# 1 "_HAL/Drivers/LCD/LCD.c" 2
# 1 "_HAL/Drivers/LCD/LCD.h" 1
# 11 "_HAL/Drivers/LCD/LCD.h"
# 1 "_HAL/Drivers/LCD/../../MCAL/GPIO/HAL_GPIO.h" 1
# 15 "_HAL/Drivers/LCD/../../MCAL/GPIO/HAL_GPIO.h"
# 1 "_HAL/Drivers/LCD/../../MCAL/GPIO/../device_config.h" 1
# 16 "_HAL/Drivers/LCD/../../MCAL/GPIO/../device_config.h"
...
# 16 "_HAL/Drivers/LCD/../../MCAL/GPIO/../device_config.h" 2
# 15 "_HAL/Drivers/LCD/../../MCAL/GPIO/HAL_GPIO.h" 2

# 1 "_HAL/Drivers/LCD/../../MCAL/GPIO/../MCAL_std_types.h" 1
# 15 "_HAL/Drivers/LCD/../../MCAL/GPIO/../MCAL_std_types.h"
...
# 15 "_HAL/Drivers/LCD/../../MCAL/GPIO/../MCAL_std_types.h" 2
...
# 17 "_HAL/Drivers/LCD/../../MCAL/GPIO/../MCAL_std_types.h" 2

# 1 "_HAL/Drivers/LCD/../../MCAL/GPIO/../compiler.h" 1
# 18 "_HAL/Drivers/LCD/../../MCAL/GPIO/../MCAL_std_types.h" 2
...
# 16 "_HAL/Drivers/LCD/../../MCAL/GPIO/HAL_GPIO.h" 2
...
# 41 "_HAL/Drivers/LCD/../../MCAL/GPIO/HAL_GPIO.h"
...
# 11 "_HAL/Drivers/LCD/LCD.h" 2
# 31 "_HAL/Drivers/LCD/LCD.h"
typedef struct{
...
std_return lcd_4bit_init( lcd_4bit_t * p_lcd)
{
    ...
    else
    {
        ...
        lcd_4bit_send_cmd(p_lcd, 0x38);
        _delay((unsigned long)((5)*((8000000UL)/4000.0)));
        lcd_4bit_send_cmd(p_lcd, 0x38);
        _delay((unsigned long)((150)*((8000000UL)/4000000.0)));
        lcd_4bit_send_cmd(p_lcd, 0x38);
        lcd_4bit_send_cmd(p_lcd, 0x01);
        lcd_4bit_send_cmd(p_lcd, 0x02);
        lcd_4bit_send_cmd(p_lcd, 0x06);
        lcd_4bit_send_cmd(p_lcd, 0x0C);
        lcd_4bit_send_cmd(p_lcd, 0x28);
        lcd_4bit_send_cmd(p_lcd, 0x80);
    }
...
std_return lcd_8bit_init( lcd_8bit_t * p_lcd)
{
    ...
    else
    {
        ...
        _delay((unsigned long)((20)*((8000000UL)/4000.0)));
        lcd_8bit_send_cmd(p_lcd, 0x38);
        _delay((unsigned long)((5)*((8000000UL)/4000.0)));
        lcd_8bit_send_cmd(p_lcd, 0x38);
        _delay((unsigned long)((150)*((8000000UL)/4000000.0)));
        lcd_8bit_send_cmd(p_lcd, 0x38);
        lcd_8bit_send_cmd(p_lcd, 0x01);
        lcd_8bit_send_cmd(p_lcd, 0x02);
        lcd_8bit_send_cmd(p_lcd, 0x06);
        lcd_8bit_send_cmd(p_lcd, 0x0C);
        lcd_8bit_send_cmd(p_lcd, 0x38);
        lcd_8bit_send_cmd(p_lcd, 0x80);
    }
...
std_return lcd_8bit_send_custom_char_pos( lcd_8bit_t * p_lcd, const uint8_t d_row, const uint8_t d_column, const uint8_t *_char, uint8_t mem_pos)
{
    ...
    {
        lcd_8bit_send_cmd( p_lcd, (0x40 + mem_pos*8) );
        uint8_t idx=0;
        for(idx=0; idx<8; idx++)
        {
...
std_return lcd_4bit_set_cursor( lcd_4bit_t * p_lcd, const uint8_t d_row, const uint8_t d_column)
{
    ...
    switch (d_row)
    {
        case (0x01): lcd_4bit_send_cmd(p_lcd, (0x80+(d_column-1)) ); break;
        case (0x02): lcd_4bit_send_cmd(p_lcd, (0x80+0x40+(d_column-1)) ); break;
        default : break;
    }
    return EXCUTION_OK;
}
...
std_return lcd_8bit_set_cursor( lcd_8bit_t * p_lcd, const uint8_t d_row, const uint8_t d_column)
{
    ...
    switch (d_row)
    {
        case (0x01): lcd_8bit_send_cmd(p_lcd, (0x80+(d_column-1)) ); break;
        case (0x02): lcd_8bit_send_cmd(p_lcd, (0x80+0x40+(d_column-1)) ); break;
        default : break;
    }
    return EXCUTION_OK;
}
